           ...
           <div class="w-full px-3 mb-6 md:mb-0">
            ...
            <div class="w-full px-3 mb-6 md:mb-0">
                    <div class="form-actions" style="margin-top:2vh;">
                        <button ref="subbutton" class="update-btn" @click.prevent="addBeneficiarioDir" style="color:#e84043; border-color:#e84043;">Añadir Beneficiario</button>
                    </div>
            </div>
        </div>
    ...
    methods:{
        ...
        addBeneficiarioDir(idx){
            if(this.checkForNull(this.nombre_benef) && this.checkForNull(this.direccion_benef)){
                this.formdata.append('payload', JSON.stringify({
            ...
            this.formdata.append('data',this.bendiform);

            axios.post('/obras/beneficiadosdirectos/add', this.formdata)
